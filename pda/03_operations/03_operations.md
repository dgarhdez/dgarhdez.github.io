...
:arrow_left: [Variables and Types](../02_variables_and_types/02_variables_and_types.md) - [Data Structures](../04_data_structures/04_data_structures.md) :arrow_right:
...
Logical operations will help up control the flow of our code as we will see in [5. Conditionals](../05_conditionals/05_conditionals.md).
...
Comparison operations will also help us compare values and control the flow of our code as we will see in [5. Conditionals](../05_conditionals/05_conditionals.md).
